...
show_help() {
    ...
    echo "  backend-go        - Backend Goサーバー                (ポート: 8080)"
    ...
    echo "  ./dev.sh logs backend-go          # Backend Goのログを表示"
    ...
    echo "  ./dev.sh env backend-go           # Backend Goの環境変数を表示"
...
show_access_urls() {
    ...
    log_info "  - Backend Go: http://localhost:8080"
    log_info "  - Backend Go Swagger: http://localhost:8080/swagger/index.html"
