...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    { className, label, error, icon: Icon, iconPosition = "left", ...props },
    ref
  ) => {
    return (
        ...
        <div className="relative">
          ...
          <input
            className={cn(
              ...
              // オートコンプリート時のスタイルを無効化
              "autofill:bg-white autofill:shadow-[inset_0_0_0px_1000px_rgb(255,255,255)] dark:autofill:bg-gray-700 dark:autofill:shadow-[inset_0_0_0px_1000px_rgb(55,65,81)]",
